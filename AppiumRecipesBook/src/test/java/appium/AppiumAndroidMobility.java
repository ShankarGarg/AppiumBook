...
public class AppiumAndroidMobility {
	...
	new AppiumAndroidMobility().settingCapsAndDriver();
	...
	// This code is not used in book but would be helpful to readers to
	// experiment on their own
	// new AppiumAndroidMobility().longPress();
	// new AppiumAndroidMobility().pinchZoom();
	// new AppiumAndroidMobility().openNotification();
	// new AppiumAndroidMobility().screenShot();
	// new AppiumAndroidMobility().keyCode();
	...
	// driver.tap(1,
	// driver.findElementById("io.appium.android.apis:id/button_toggle"),
	// 1000);
	...
	TouchAction dragNDrop = new TouchAction(driver).longPress(dragDot1).moveTo(dragDot3).release().perform();
	...
	System.out.println(gallery.findElementsByClassName("android.widget.ImageView").size());
	...
	System.out.println(driver.findElementsById("com.android.systemui:id/carrier_label").size());
    }
